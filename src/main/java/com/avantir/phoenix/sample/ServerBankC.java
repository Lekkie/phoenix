    ...
    public static void main(String[] args){
        ...
        try{
            ...
            server.addMessageListener(new IsoMessageListener<IsoMessage>() { // [3]
                ...
                public boolean onMessage(ChannelHandlerContext ctx, IsoMessage isoMessage) {
                    if(IsoUtil.isRequest(isoMessage)){
                        System.out.println("Incoming request to Server Bank A: " +isoMessage.debugString());
                        ...
                        System.out.println("Incoming response to Server Bank A: " + isoMessage.debugString());
                    }
                    return false;
                }
            });
            ...
            if (server.isStarted()) { // [7]
                System.out.println("Server C on port " + port + " is started");
