package com.avantir.phoenix.utils;

import com.avantir.phoenix.messaging.ISO8583SrcNode;
...
public class IsoUtil {
    ...
    public static void sendResponse(ISO8583SrcNode iso8583SrcNode, ChannelHandlerContext ctx, IsoMessage isoReq, String packagerName, boolean binaryBitmap, int responseCode){
    ...
    public static IsoMessage returnResponse(IsoMessage isoMessage, String packagerName, boolean binaryBitmap, int respCode){
    ...
    public static String getOriginalDataElement(IsoMessage isoMessage){
        ...
        String originalDataElement = type + stan + transmissionDateTime + acquiringInstId + forwardingInstId;
    ...
    public static Long generateSwitchKey(IsoMessage isoMessage, SwitchKeyOrigDataElemService switchKeyOrigDataElemService){
        String originalDataElement = getOriginalDataElement(isoMessage);
        //Save switchkey & original Data element
        SwitchKeyOrigDataElem switchKeyOrigDataElem = new SwitchKeyOrigDataElem();
        switchKeyOrigDataElem.setOriginalDataElement(originalDataElement);
        try {
            switchKeyOrigDataElemService.create(switchKeyOrigDataElem);
        }
        catch(DataIntegrityViolationException divex){
            logger.error("receiveRequestFromRemote: Duplicate transaction type, stan, transmission datetime, acquiringId, forwardingId already exists", divex);
            return -1L;
        }
        catch(Exception ex){
            logger.error("receiveRequestFromRemote: Unable to create switch key", ex);
            return 0L;
        }

        switchKeyOrigDataElem = switchKeyOrigDataElemService.findByOriginalDataElement(originalDataElement);
        if(switchKeyOrigDataElem == null){
            logger.error("receiveRequestFromRemote: Switch key not found for this message");
            return 0L;
        }
        return  switchKeyOrigDataElem.getId();
    }

    public static Long getSwitchKey(IsoMessage isoMessage, SwitchKeyOrigDataElemService switchKeyOrigDataElemService){
        String originalDataElement = getOriginalDataElement(isoMessage);
        SwitchKeyOrigDataElem switchKeyOrigDataElem = switchKeyOrigDataElemService.findByOriginalDataElement(originalDataElement);
        return switchKeyOrigDataElem == null ? 0L : switchKeyOrigDataElem.getId();
    }
    ...
    */
    ...
    public final static int RESP_00 = 00;
    public final static int RESP_04 = 04; // Pick-up card
    public final static int RESP_12 = 12; // Invalid transaction
    public final static int RESP_13 = 13; // Invalid amount
    public final static int RESP_14 = 14; // Invalid card number
    public final static int RESP_30 = 30; // Format error
    public final static int RESP_33 = 33; // Expired card, pick up
    public final static int RESP_34 = 34; // Suspected fraud
    public final static int RESP_40 = 40; // Function not supported
    public final static int RESP_54 = 54; // Expired card
    public final static int RESP_68 = 68; // Response received too late
    public final static int RESP_91 = 91;
    public final static int RESP_92 = 92;
    public final static int RESP_94 = 94; // duplicate transaction
    public final static int RESP_96 = 96;
